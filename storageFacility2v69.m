classdef storageFacility2v69 < handle
	...
	methods
		...
		function sf = storageFacility2v69(cap,inventory,rc,hc,rp,index,proc_num)
		...
		function sf = iterateWeek(sf, sum_shipped, futures_per_week_FCOJ,proc_plants, big_D, big_P, time, ORA_demand, POJ_demand, FCOJ_demand, ROJ_demand, cities, sim_index, plants_open)
