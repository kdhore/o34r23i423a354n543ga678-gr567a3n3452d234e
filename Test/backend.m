...
decision = YearDataforDecisions(filename1, ojObject);

dec = Decisions(filename1,ojObject,decision.pricing_ORA_dec,decision.pricing_POJ_dec,decision.pricing_ROJ_dec,decision.pricing_FCOJ_dec,YearDataRecord);
